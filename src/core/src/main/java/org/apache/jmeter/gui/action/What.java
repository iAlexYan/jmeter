    ...
    public void doAction(ActionEvent e) throws IllegalUserActionException {
        ...
        if (ActionNames.WHAT_CLASS.equals(e.getActionCommand())){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "创建 "+s, "JVM堆栈", JOptionPane.INFORMATION_MESSAGE);
            } catch (Exception ex) { // NOSONAR We show cause in message
                JOptionPane.showMessageDialog(null, ex.toString(), "JVM堆栈", JOptionPane.ERROR_MESSAGE);
            }
        } else if (ActionNames.THREAD_DUMP.equals(e.getActionCommand())){
            try {
                String s = ThreadDumper.threadDump();
                JOptionPane.showMessageDialog(null, "创建 "+s, "线程堆栈", JOptionPane.INFORMATION_MESSAGE);
            } catch (Exception ex) { // NOSONAR We show cause in message
                JOptionPane.showMessageDialog(null, ex.toString(), "线程堆栈", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
